...
function resizeCanvas() {
    ...
    // Update viewport scale if needed
    if (viewport) {
        viewport.scale = Math.min(canvas.width, canvas.height) / 800; // Adjust 800 as needed for your game's scale
    }
}
...
setInterval(() => {
    try {
        const currentWinState = winOrLose() === "win";
        ...
        console.error("Error checking win condition:", e);
    }
